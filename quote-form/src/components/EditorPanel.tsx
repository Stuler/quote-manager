    ...
    return (
        <div className="panel__inner">
            ...
            <div className="fieldRow">
                ...
                <div className="field">
                    <label>Krajina</label>
                    <input value={draft.customer.country ?? ""} onChange={(e) => onCustomerChange({ country: e.target.value })} />
                </div>
            </div>
            ...
            <div className="items">
                {draft.items.map((it) => (
                    <div key={it.id} className="itemCard">
                        ...
                        <div className="field">
                            <label>Popis</label>
                            <input value={it.description ?? ""} onChange={(e) => onItemChange(it.id, { description: e.target.value })} />
                        </div>
